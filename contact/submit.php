...
if(!validateMinLength($_POST['phone'], 10))$err[]='The phone number field must be at least 10 numbers'; 			
if(!validateMaxLength($_POST['phone'], 23))$err[]='The phone number field must be less than 22 numbers';
if(validateMaxLength($_POST['phone'], 23) && validateMinLength($_POST['phone'], 10) && !validatePhone($_POST['phone']))$err[]='The phone number is not valid. Numbers and Hyphens (-) only'; 			
...
//To send to more than one email, add another email below, separating the emails with , - ('example@email.com, example@email2.com')
$recipients = array('derek@dinsmoredesign.com');
